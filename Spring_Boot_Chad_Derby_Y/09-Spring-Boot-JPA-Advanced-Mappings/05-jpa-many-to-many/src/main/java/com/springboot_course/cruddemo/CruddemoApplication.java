...
public class CruddemoApplication {
    ...
    private void addMoreCoursesForStudent(AppDAO appDAO) {
        ...
        Course tempCourse1 = new Course("Defeat a strider in 3 steps");
        Course tempCourse2 = new Course("How to easily dispose of manhacks");
    ...
    private void findStudentAndCouses(AppDAO appDAO) {
        int theId = 2;
    ...
    private void createcourseAndStudents(AppDAO appDAO) {
        ...
        Student tempStudent1 = new Student("Citizen", "CITY17", "city17@gmail.com");
        Student tempStudent2 = new Student("Citizen2", "CITY17", "city17@gmail.com");
